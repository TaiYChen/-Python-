...
# Form implementation generated from reading ui file 'accumulate.ui'
#
...
class Ui_Accumulate(object):
    def setupUi(self, Accumulate):
        ...
        self.btnExam.clicked.connect(Accumulate.btnExam_Clicked)
        self.btnAppend.clicked.connect(Accumulate.btnAppend_Clicked)
        self.btnReview.clicked.connect(Accumulate.btnReview_Clicked)
